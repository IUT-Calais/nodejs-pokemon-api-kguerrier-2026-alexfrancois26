...
async function main() {
  ...
  await prisma.pokemonCard.create({
    data: {
      ...
      weaknessType: { connect: { name: 'Water' } },
      lifePoints: 78,
      size: 1.7,
      weight: 90.5,
  ...
  await prisma.pokemonCard.create({
    data: {
      ...
      weaknessType: { connect: { name: 'Electric' } },
      lifePoints: 79,
      size: 1.6,
      weight: 85.5,
  ...
  await prisma.pokemonCard.create({
    data: {
      ...
      weaknessType: { connect: { name: 'Fire' } },
      lifePoints: 80,
      size: 2.0,
      weight: 100.0,
  ...
  await prisma.pokemonCard.create({
    data: {
      ...
      weaknessType: { connect: { name: 'Ground' } },
      lifePoints: 35,
      size: 0.4,
      weight: 6.0,
  ...
  await prisma.pokemonCard.create({
    data: {
      ...
      pokedexId: 130,
      type: { connect: { name: 'Water' } },
      weaknessType: { connect: { name: 'Grass' } },
      lifePoints: 95,
      size: 6.5,
      weight: 235.0,
  ...
  await prisma.pokemonCard.create({
    data: {
      ...
      weaknessType: { connect: { name: 'Dark' } },
      lifePoints: 106,
      size: 2.0,
      weight: 122.0,
  ...
  await prisma.pokemonCard.create({
    data: {
      ...
      weaknessType: { connect: { name: 'Flying' } },
      lifePoints: 90,
      size: 1.6,
      weight: 130.0,
  ...
  await prisma.pokemonCard.create({
    data: {
      ...
      weaknessType: { connect: { name: 'Fighting' } },
      lifePoints: 150,
      size: 2.1,
      weight: 460.0,
  ...
  await prisma.pokemonCard.create({
    data: {
      ...
      pokedexId: 65,
      type: { connect: { name: 'Psychic' } },
      weaknessType: { connect: { name: 'Ghost' } },
      lifePoints: 55,
      size: 1.5,
      weight: 48.0,
